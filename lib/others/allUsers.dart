...
//             firestore.collection('users').doc(frienduid).collection('chatRoom').updateDate({
//              "friendsId": FieldValue.arrayUnion(currentUser)
           
//             });

//             firestore.collection('users').doc(currentUser).updateDate({
//               "friendsId": FieldValue.arrayUnion(frienduid)
//             });
//             }
// }
