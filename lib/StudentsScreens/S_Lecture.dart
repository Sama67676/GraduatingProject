...
class S_LectureScreen extends StatefulWidget {
  S_LectureScreen({this.postId,this.title, this.type, this.classId,this.teacherId, this.description,this.attachment,this.attachmentType, this.time});
  String? postId;
  String? classId;
  String? teacherId;
 String? type;
 ...
 String? time;
  @override
  State<S_LectureScreen> createState() => _S_LectureScreenState(this.postId,this.title, this.type, this.teacherId, this.classId, this.description,this.attachment,this.attachmentType,this.time);
}
...
String?attachmentType;
String? time;
    _S_LectureScreenState(this.postId,this.title,this.type, this.teacherId, this.classId,  this.description,this.attachment,this.attachmentType,this.time);
