...
class S_GroupProfile extends StatefulWidget {
  const S_GroupProfile({super.key,  this.groupImage,  required this.groupName, required this.groupId});
  final String? groupImage;
  final String groupName;
  final String groupId;

  @override
  State<S_GroupProfile> createState() => _S_GroupProfileState(groupImage, groupName, groupId);
}

class _S_GroupProfileState extends State<S_GroupProfile> {
final String? groupImage;
  final String groupName;
  final String groupId;
  
    
   _S_GroupProfileState(this.groupImage, this.groupName, this.groupId);
