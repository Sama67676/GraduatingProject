                        ...
                        child: 
                            Padding(
                              ...
                              const Padding(
                                ...
                                child: Expanded(flex:2, child: Text('Add teacher',style:TextStyle(fontSize: 25, color: Color.fromARGB(255, 8, 61, 104)))),
                              ),
                               Expanded(
                                flex: 0,
                                 child: 
                                          ...
                                          child: ListView(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  CircleAvatar(
                                                    ...
                                                    child:  Container(
                                                      height: 80,
                                                      width: 80,
                                                      child: Image.asset('images/addTeacher.png')),
                                                  ),
                                                  const Padding(
                                                    padding: EdgeInsets.symmetric(horizontal:12),
                                                    child: Text('Add new teacher account !', style: TextStyle(color: Colors.white,
                                              ...
                                              const Padding(
                                                ...
                                                child: Text('Enter email :', style: TextStyle(color: Colors.white60,
                                                      fontFamily: 'HP Simplified Light', fontWeight: FontWeight.bold,
                                                      fontSize: 20
                                                      ),),
                                              ),
                                              Expanded(
                                               ...
                                               const Padding(
                                                padding: EdgeInsets.symmetric(vertical:14, horizontal: 10),
                                                child: Text('Enter Password :', style: TextStyle(color: Colors.white60,
                                                      fontFamily: 'HP Simplified Light', fontWeight: FontWeight.bold,
                                                      fontSize: 20
                                                      ),),
                                              ),
                                              Expanded(
                                               ...
                                               const Padding(
                                                padding: EdgeInsets.symmetric(vertical:14, horizontal: 10),
                                                child: Text('Enter name :', style: TextStyle(color: Colors.white60,
                                                      fontFamily: 'HP Simplified Light', fontWeight: FontWeight.bold,
                                                      fontSize: 20
                                                      ),),
                                              ),
                                              Expanded(
                                                ...
                                                child: Expanded(
                                                  ...
                                                  const Padding(
                                                padding: EdgeInsets.symmetric(vertical:10, horizontal: 10),
                                                child: Text('choose phase :', style: TextStyle(color: Colors.white60,
                                                      fontFamily: 'HP Simplified Light', fontWeight: FontWeight.bold,
                                                      fontSize: 20
                                                      ),),
                                              ),
